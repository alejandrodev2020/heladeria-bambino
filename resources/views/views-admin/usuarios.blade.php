                ...
                <div class="col-lg-12 mb-4 order-0">
                  <div class="card" style="height: 80vh;">
                    <div class="d-flex align-items-end row">
                      <div class="col-sm-10">
                        <div class="card-body">
                          <h5 class="card-title text-primary">Gestion de Activos</h5>
                        </div>
                      </div>
                        ...
                        <div class="table-responsive text-nowrap">
                          <table class="table">
                            ...
                            <tbody class="table-border-bottom-0">
                                <?php 
                                use App\Activo;
                                $articles = Activo::orderBy('id_activos')->get();
                                ?>
                                ...
                                <tr>
                                    ...
                                    <td><span class="badge bg-label-primary me-1">{{ $a->estado }}</span></td>
                                    <td>
