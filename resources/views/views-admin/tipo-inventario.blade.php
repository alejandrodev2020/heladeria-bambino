        ...
        <div class="layout-page">
                ...
                <div class="col-lg-12 mb-4 order-0">
                  <div class="card">
                    <div class="d-flex align-items-end row">
                      <div class="col-sm-10">
                        <div class="card-body">
                          <h5 class="card-title text-primary">Gestion de Tipos de Inventario</h5>
                        </div>
                      </div>
          ...
          <script>
            ...
            function listarActivos(){
              $.ajax({
                      type: "GET",
                      url: 'https://www.tecnoweb.org.bo/inf513/grupo07sa/heladeria-bambino/public/tipo-inventario',
                      headers: {'Authorization': 'Bearer xxxxxxxxxxxxx'},
                      data: $(this).serialize(),
                      success: function(response)
                      {
                        let list = response.tipo_inventario.data;
                        listadoActivos = list;
                        let myarray2 = [];

                        for (let index = 0; index < list.length; index++) {
                          let element = list[index];
                          let tmp = '<td>'+element.id_tipo_inventario+'</td>'
